<template>
  <section id="eco" class="page-section">
    <div class="chart-header">
      <h2>Carbon Footprint of Energy Use</h2>
    </div>
    ...
    <div class="eco-subsection">
      <div class="section-container">
        ...
        <div class="text-container">
          ...
          />
          <p>
            Transport tends to be the single largest contributor in most European countries, reflecting heavy reliance
            on fossil fuels for road mobility. In Lithuania, transport accounts for roughly two-thirds of per-capita
            emissions. In Denmark, Spain, and Portugal it exceeds half. At the other extreme, industry dominates in
            Slovakia and Czechia, where steel production, automotive manufacturing, and a heavy reliance on coal for
            heating, industry, and electricity generation push totals above 4 tCO&#x2082; per person. Residential
            emissions vary depending on climate, insulation standards, and the fuel mix for heating. Norway stands out
            with residential emissions near zero (0.08 tCO&#x2082;/cap), thanks to a grid that is 98% renewable (almost
            entirely hydropower), widespread use of heat pumps for heating, and the world's highest EV adoption rate,
            keeping its overall footprint remarkably low for a country with such a high standard of living.
          </p>
        </div>
      </div>
      ...
      <div class="section-container">
        ...
        <div class="text-container">
          ...
          <p>
            ...
            electric car being a prime example of this. A fact that can be lost in this though, is that any benefits in
            terms of emissions through often costly and disruptive switches, are only as beneficial as the electricity
            is clean. The cards below (based on broad averages and approximations) demonstrate how impactful the effect
            can be, essentially highlighting the importance of electricity obtained from clean sources.
          </p>
          ...
          <details class="sources-details">
            ...
            <ul class="sources-list">
              <li>
                ...
                <a href="https://ptua.org.au/myths/energy/" target="_blank"
                  >PTUA – Myth: Public transport doesn't really save energy</a
                >. Total energy per passenger-km including vehicle manufacturing. Car (ICE): 3.0–4.4, EV: 1.2–2.0,
                Train: 0.05–0.2, Tram: 0.17–0.8 MJ/pkm. Ranges reflect occupancy assumptions (cars: 1.1–1.5 passengers;
                trains/trams: peak vs off-peak patronage).
              </li>
              <li>
              ...
              <li>
                <strong>Gas heating (215 gCO&#x2082;/kWh_th)</strong>: Natural gas space heating. Based on emission
                factor ~205 gCO&#x2082;/kWh with typical boiler efficiency ~90%.
              </li>
              <li>
                <strong>Household electricity (3,600 kWh/yr)</strong>:
                <a
                  href="https://www.odyssee-mure.eu/publications/efficiency-by-sector/households/electricity-consumption-dwelling.html"
                  target="_blank"
                  >Odyssee-MURE – Electricity consumption per dwelling</a
                >. EU average of 3.6 MWh per dwelling, widely used as a median for medium-sized households. Varies
                greatly by country (from ~1.8 MWh in Romania to ~8.5 MWh in Sweden).
              </li>
              <li>
