          ...
          <div class="fuel-group-content">
            ...
            <div class="fuel-text-wrapper">
              <p class="fuel-text">
                ...
                petrochemical feedstock. High energy density (45 MJ/kg). Nearly all European countries import 90%+
                (2022): Germany (97%), France (99%), Italy (93%). Norway is a major net exporter. Non-EU dependency
                typically 75-90% across the EU (2022).
              </p>
            </div>
          </div>
